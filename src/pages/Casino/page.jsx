    ...
    >
      <div>
        ...
        <div className="grid grid-cols-12 gap-2">
          ...
          {/* Input Section */}
          <div className="col-span-12 lg:col-span-4 2xl:col-span-3 grid grid-cols-2 gap-2">
            ...
            <div
            key={item.id}
              className="cursor-pointer space-x-1 w-5 items-center py-2 text-[14px] flex px-2 text-white bg-custom-bg-color  hover:bg-black"
             
            >
               <div className='text-[#18AC27] p-1 rounded-full font-semibold text-[22px] bg-drop-down-color dark:bg-black'>
               {item.valueone}
              </div>
